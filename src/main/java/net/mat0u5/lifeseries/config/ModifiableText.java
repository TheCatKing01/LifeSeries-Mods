...
public enum ModifiableText {
	...
	,LISTS_NICELIST_START_INFO("§7You have been chosen to be on the §dnice list§7. You have 10 minutes to vote using /vote to agree with the other §dpinks§7 on a §2non-pink§7 to gain a life. Within that time you are unable to be targeted by all players including §cred names§7.")
	,LISTS_NICELIST_VOTE("\n §6[§e!§6]§7 You voted for {}§7.\n", List.of("Player"))
