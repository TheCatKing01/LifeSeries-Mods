...
public enum ModifiableText {
	...
	,LISTS_NICELIST_START_INFO("§7You have been chosen to be on the §dnice list§7. You have 10 minutes to vote using §l/vote §r§7to agree with the other §dpinks§7 on a §2non-pink§7 to gain a life. Within that time you are unable to be targeted by all players including §cred names§7.")
	,LISTS_NICELIST_VOTE("\n §6[§e!§6]§7 You voted for {}§7.\n", List.of("Player"))
	,LISTS_NICELIST_VOTE_REMINDER("\n§7Don't forget to {}§7!\n", List.of("ClickHere"))
    ,LISTS_NICELIST_VOTE_TITLE("Vote for who should get a life")
	,LISTS_NAUGHTYLIST_START_INFO("§7You have been chosen to be on the §5naughty list§7. As a purple name all players are able to target and kill you untill the 10 minute timer ends. When it ends you revert back to your previous colour.")
