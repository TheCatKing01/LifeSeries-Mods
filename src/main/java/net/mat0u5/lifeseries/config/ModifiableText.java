...
public enum ModifiableText {
	...
	,LISTS_NICELIST_START_INFO("§6[§e!§6]§7 At sunset, players on the nice list will vote to give a §2non-pink§7 name a life.")
	,LISTS_NICELIST_VOTE("\n §6[§e!§6]§7 You voted for {}§7.\n", List.of("Player"))
	,LISTS_NICELIST_VOTE_REMINDER("\n§7Don't forget to {}§7!\n", List.of("ClickHere"))
    ,LISTS_NICELIST_VOTE_TITLE("Vote for who should get a life")
	,LISTS_NAUGHTYLIST_START_INFO(" §6[§e!§6]§7 People on the §cnaughty list§7 have a purple name and can be killed.\n")
