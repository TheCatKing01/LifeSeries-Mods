...
public enum ModifiableText {
    ...
    ,CLIENT_MODE_REQUIRE_CLIENT("You need at least one admin with the mod installed client-side to do this.")
    ,CLIENT_MODE_SET("Client mode has been turned {}.", List.of("ON/OFF"))
    ,CLIENT_MODE_OFF_SPAWN_TRIVIA("Client mode was off, so it has been enabled for trivia bot spawning.")
    ,TRIVIA_BOT_SPAWN_REQUIRES_CLIENTMODE("Spawning trivia bots in this season requires client mode.")
    ...
    ,DOUBLELIFE_SOULMATE_SPLIT_SELF(Seasons.DOUBLE_LIFE, "§cYour soulmate link has been split.")
    ,DOUBLELIFE_SOULMATE_SPLIT_OTHER(Seasons.DOUBLE_LIFE, "§cYou are no longer linked with your soulmate.")
    ,DOUBLELIFE_LIVES_RANDOMIZE_TITLE_BOTH(Seasons.DOUBLE_LIFE, "§7Assigning random lives...")
    ,DOUBLELIFE_LIVES_RANDOMIZE_TITLE_SOLO(Seasons.DOUBLE_LIFE, "§7Assigning random life...")
    ...
    ,WILDLIFE_MAKEITWILD_TRANSCRIPT(Seasons.WILD_LIFE, "Make it Wild triggered.")
    ...
    ,LISTS_ROLLING_REVEAL_TITLE("§7The lists are...")
    ,LISTS_NO_LIST_TITLE("§7You are not on either list.")
    ,LISTS_NICELIST_TITLE("§aTHE NICE LIST")
    ,LISTS_NAUGHTYLIST_TITLE("§cTHE NAUGHTY LIST")
    ,LISTS_NOTICE_ADDED("§6[§e!§6]§7 You are now on the {} list.", List.of("nice/naughty"))
    ,LISTS_NOTICE_REMOVED("§6[§e!§6]§7 You are no longer on a list.")
    ,LISTS_NICELIST_START_INFO("\n §6[§e!§6]§7 You are on the Nice List for {} minute(s).\n §6[§e!§6]§7 Use {}§7 to vote.\n", List.of("minutes", "ClickHere"))
    ,LISTS_NAUGHTYLIST_START_INFO("\n §6[§e!§6]§7 You are on the Naughty List for {} minute(s).\n", List.of("minutes"))
    ,LISTS_NICELIST_VOTE_TITLE("Vote for who should get a life")
    ,LISTS_NICELIST_VOTE("\n §6[§e!§6]§7 You voted for {}§7.\n", List.of("Player"))
    ,LISTS_NICELIST_VOTE_REMINDER("\n§7Don't forget to {}§7!\n", List.of("ClickHere"))
    ,LISTS_VOTE_END_TITLE("§cThe list vote will end in...")
    ...
    ,LISTS_VOTE_RESULT("§2The winner is...")
