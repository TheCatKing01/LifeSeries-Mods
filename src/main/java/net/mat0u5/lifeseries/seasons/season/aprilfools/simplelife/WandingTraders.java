...
public class WandingTraders {
    ...
    private boolean isSimpleLife() {
        return seasonConfig.SIMPLE_LIFE.get(seasonConfig);
    }

    private int getTradersMaxAmount() {
        return seasonConfig.TRADERS_MAX_AMOUNT.get(seasonConfig);
    }

    private boolean isComplexLifeTrades() {
        return seasonConfig.COMPLEX_LIFE_TRADES.get(seasonConfig);
    }

    public void tickSessionOn(MinecraftServer server) {
        if (!isSimpleLife()) return;
        ...
        if (traderCount >= getTradersMaxAmount()) return;
    ...
    public boolean trySpawnTrader(ServerLevel level) {
        ...
        WanderingTrader trader = LevelUtils.spawnEntity(EntityType.WANDERING_TRADER, level, spawnPos);
        ...
        //? if <= 1.20.3 {
            ...
            /*if (!isComplexLifeTrades()) {
                ...
                if (rand == 0) {
                    offers.add(new MerchantOffer(new ItemStack(Items.DIRT, 32), ItemStack.EMPTY, Items.OAK_SAPLING.getDefaultInstance(), 0, 999999, 0, 0, 0));
                } else {
                    offers.add(new MerchantOffer(new ItemStack(Items.DIRT, 32), ItemStack.EMPTY, Items.SPRUCE_SAPLING.getDefaultInstance(), 0, 999999, 0, 0, 0));
                }
                ...
                offers.add(new MerchantOffer(new ItemStack(Items.DIRT, 32), ItemStack.EMPTY, Items.OAK_SAPLING.getDefaultInstance(), 0, 999999, 0, 0, 0));
                offers.add(new MerchantOffer(new ItemStack(Items.DIRT, 5), ItemStack.EMPTY, Items.BONE.getDefaultInstance(), 0, 999999, 0, 0, 0));
                offers.add(new MerchantOffer(new ItemStack(Items.DIRT, 5), ItemStack.EMPTY, Items.SAND.getDefaultInstance(), 0, 999999, 0, 0, 0));

                offers.add(new MerchantOffer(new ItemStack(Items.SAND, 10), ItemStack.EMPTY, Items.SUGAR_CANE.getDefaultInstance(), 0, 999999, 0, 0, 0));

                offers.add(new MerchantOffer(new ItemStack(Items.OAK_PLANKS, 2), ItemStack.EMPTY, Items.COBBLESTONE.getDefaultInstance(), 0, 999999, 0, 0, 0));
                offers.add(new MerchantOffer(new ItemStack(Items.OAK_PLANKS, 40), ItemStack.EMPTY, Items.WATER_BUCKET.getDefaultInstance(), 0, 999999, 0, 0, 0));
                offers.add(new MerchantOffer(new ItemStack(Items.OAK_PLANKS, 40), ItemStack.EMPTY, Items.LAVA_BUCKET.getDefaultInstance(), 0, 999999, 0, 0, 0));
                offers.add(new MerchantOffer(new ItemStack(Items.OAK_PLANKS, 32), ItemStack.EMPTY, Items.COW_SPAWN_EGG.getDefaultInstance(), 0, 999999, 0, 0, 0));
