...
//?}
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition midfront = mid.addOrReplaceChild("midfront", CubeListBuilder.create().texOffs(35, 37).addBox(-2.49F, -4.01F, -5.5F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition midfront_r1 = midfront.addOrReplaceChild("midfront_r1", CubeListBuilder.create().texOffs(16, 59).addBox(-2.0F, -4.0F, -1.0F, 5.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, -6.5F, 0.0F, 3.1416F, 0.0F));

        PartDefinition midfront_r2 = midfront.addOrReplaceChild("midfront_r2", CubeListBuilder.create().texOffs(7, 63).addBox(-1.0F, -3.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, -6.75F, 0.0F, 3.1416F, 0.0F));
        ...
        PartDefinition propeller = body.addOrReplaceChild("propeller", CubeListBuilder.create().texOffs(32, 53).addBox(-2.0F, -10.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(36, 58).addBox(-0.5F, -12.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, 0.5F));
        ...
        PartDefinition parachute = body.addOrReplaceChild("parachute", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -13.6F, -4.0F, 16.0F, 0.6F, 16.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 34).addBox(-8.0F, -13.0F, -4.0F, 0.5F, 0.5F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, -3.5F));
